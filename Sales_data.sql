...
-- 2. Write a SQL query to retreive all transactions where the categories is "clothing" and the quantity sold is more than 4 in the month of Nov-2022
SELECT *
FROM retail_sales
...
-- 4. Wtite a SQL query to find the average age of customers who purchased items from the "Beauty" category.
